...
//        }
        ...
        self.centre.getNotificationSettings(completionHandler: { (settings) in
            if settings.authorizationStatus == .notDetermined {
                ...
                // request permission
                self.centre.requestAuthorization(options: options) { (granted, error) in
                    if !granted {
...
//        let triggerWeekly = Calendar.current.dateComponents([.weekday, .hour, .minute, .second], from: datetime)
    ...
    func setPEFRReminder(pEFRReminderDataModel:PEFRReminderDataModel)  {
        ...
        let drAppInfo = ["title":"PEFR reminder","body":"Just a remind to you have to  PEFR. at \(pEFRReminderDataModel.reminderTiming!)","dateTime":pEFRReminderDataModel.dateTime,"pefrID":pEFRReminderDataModel.pefrID,"reminderType":"PEFRReminder"]
    ...
    func setPEFRReminderSnooze(pEFRReminderDataModel:PEFRReminderDataModel)  {
        ...
        let drAppInfo = ["title":"PEFR reminder","body":"Just a remind to you have to PEFR. at \(pEFRReminderDataModel.reminderTiming!)","dateTime":pEFRReminderDataModel.dateTime,"pefrID":"snooze"+pEFRReminderDataModel.pefrID,"reminderType":"PEFRReminder"]
